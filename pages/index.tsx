      ...
      <section className="mt-12 px-4 sm:px-6 max-w-6xl mx-auto">
        <div className="bg-slate-900/50 border border-slate-800 rounded-2xl p-6 sm:p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-bold text-white">Video Conferencing News</h2>
          ...
          <div className="grid gap-3">
            {vcNews.map((article, idx) => (
              <a
                ...
                className="group flex items-start gap-4 p-4 rounded-xl bg-slate-800/50 hover:bg-slate-800 transition-colors border border-slate-700/50 hover:border-slate-600"
              >
                <div className="flex-shrink-0 w-8 h-8 rounded-lg bg-slate-700 flex items-center justify-center text-xs font-bold text-slate-400">
                  {idx + 1}
                </div>
          ...
          <p className="text-xs text-slate-600 mt-4 text-center">
            Headlines sourced from global tech feeds · Click to read full article in new tab
          </p>
        </div>
      </section>
